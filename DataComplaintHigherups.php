...
$records = mysqli_query($conn, "SELECT * FROM datacomplaint"); 
...
<tr>
    ...
    <td><a href="deleteComplaintHigh.php?id=<?php echo $data['bil']; ?>" class="btn btn-danger">DELETE</a></td>
    <td><?php if ($data['status'] == 'progress')
        {
        ?>
            <a href="Progress.php?bil=<?php echo $data['bil']; ?>" class="btn btn-warning">SUBMITTED</a>
