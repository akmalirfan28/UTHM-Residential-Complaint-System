  ...
  <span style="font-size:28px;cursor:pointer;color:White;margin-left: 20px;" onclick="openNav()">&#9776;  UTHM RESIDENTIAL COMPLAINT SYSTEM </span>
    ...
    <form class="modal-content" action="/action_page.php" method="post">
        <div class="container">
            ...
            <div class="clearfix">
                <button type="button" class="cancelbtn" name = "cancel" value = "cancel"><a href="DataComplaintHigherups.php" class="btn">CANCEL</a></button>
                <button type="button" class="deletebtn" name = "delete" value = "delete"><a href="deletecomphigh.php?id=<?php echo $id; ?>" class="btn">DELETE</a></button>
            </div>
        </div>
    </form>
